        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-xs text-gray-500">Artisanat authentique</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h4 class="font-semibold text-nissa-choco mb-1">Livraison soignée</h4>
                    <p class="text-xs text-gray-500">Emballage avec soin</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-xs text-gray-500">Transactions protégées</p>
                </div>
            </div>
        </div>
    </section>
