            ...
            <form method="POST" action="{{ route('admin.collections.enregistrer') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nom" required
                        placeholder="Ex: Été 2026, Bohème..."
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" placeholder="Description de la collection..."
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                @if ($collection->description)
                                    <p class="text-xs text-gray-400 mt-1 line-clamp-1">{{ $collection->description }}</p>
                                @endif
                            </div>
                        </div>
