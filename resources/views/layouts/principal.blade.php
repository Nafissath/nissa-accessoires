...
<head>
    ...
    <meta name="description"
        content="{{ $description ?? 'Découvrez nos accessoires faits main au Bénin : chouchous, sacs, trousses. Livraison partout au Bénin. Paiement Mobile Money sécurisé.' }}">

    <meta name="keywords"
        content="{{ $keywords ?? 'accessoires Bénin, chouchous fait main, sacs artisanaux, mode africaine, Nissa Accessoires' }}">

    {{-- Open Graph --}}
    <meta property="og:title" content="{{ $title ?? 'Nissa Accessoires' }}">
    <meta property="og:description"
        content="{{ $description ?? 'Créations artisanales faites main au Bénin' }}">
    ...
    <link
        href="https://fonts.bunny.net/css?family=playfair-display:400,500,600,700|poppins:300,400,500,600"
        rel="stylesheet" />
...
<body class="min-h-full font-sans text-nissa-choco antialiased">
    ...
    <header class="bg-[#FCFAF8] border-b border-[#eee8e3] sticky top-0 z-40">
        ...
        >
            ...
            >
                ...
                <a
                    href="{{ route('boutique', ['categorie' => 'sacs']) }}"
                    class="px-4 py-3 rounded-xl
                           text-sm font-medium text-gray-600
                           hover:bg-nissa-rose/10
                           hover:text-nissa-rose transition pl-8"
                ...
                <a
                    href="{{ route('boutique', ['categorie' => 'trousses']) }}"
                    class="px-4 py-3 rounded-xl
                           text-sm font-medium text-gray-600
                           hover:bg-nissa-rose/10
                           hover:text-nissa-rose transition pl-8"
            ...
            >
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <div
                            class="text-2xl font-semibold tracking-[0.18em]"
                            style="font-family: 'Playfair Display', serif;"
                        >
                            NISSA
                        </div>
                    ...
                    <div class="flex items-center gap-3 lg:hidden">
                        ...
                        <a
                            href="https://www.tiktok.com/@nissa_accessoires"
                            target="_blank"
                            rel="noopener noreferrer"
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-white/70">
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <svg
                                class="w-4 h-4 text-nissa-rose shrink-0"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
    ...
    <a
        href="https://wa.me/2290191309710?text={{ urlencode("Bonjour Nissa Accessoires ! Je visite votre site et j'aimerais avoir plus d'informations.") }}"
        target="_blank"
        rel="noopener noreferrer"
