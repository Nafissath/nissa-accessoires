...
<section class="relative overflow-hidden bg-[#FCFAF8]">
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-8 py-20 lg:py-28">
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <span class="inline-flex items-center gap-3 text-[11px] uppercase tracking-[0.35em] text-nissa-rose font-medium">
            ...
            <h1
                class="mt-7 text-5xl sm:text-6xl lg:text-7xl leading-[1.05] text-nissa-choco"
...
<section class="bg-nissa-choco text-white py-16 md:py-20 overflow-hidden relative">
    ...
    <div class="relative max-w-4xl mx-auto px-5 text-center">
        ...
        <p
            class="text-2xl md:text-3xl italic leading-relaxed font-light text-white/95"
            style="font-family:'Playfair Display', serif;"
        >
    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div class="grid lg:grid-cols-[0.8fr_1.2fr] gap-14 lg:gap-24 items-start">
            ...
            <div class="lg:sticky lg:top-32">
                ...
                <h2
                    class="mt-4 text-4xl sm:text-5xl leading-tight text-nissa-choco"
                    style="font-family:'Playfair Display', serif;"
                >
                    Tout commence<br>
                    par une idée.
            ...
            <div class="space-y-6 text-gray-600 leading-8">
                ...
                <div class="pt-5">
                    ...
                    <p
                        class="text-xl text-nissa-choco italic leading-8"
                        style="font-family:'Playfair Display', serif;"
                    >
    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div class="grid lg:grid-cols-2 gap-14 lg:gap-24 items-center">
            ...
            <div>
                ...
                <h2
                    class="text-6xl md:text-8xl font-medium text-nissa-choco leading-none"
                    style="font-family:'Playfair Display', serif;"
                >
            ...
            <div class="space-y-6 text-gray-700 leading-relaxed">
                ...
                <div class="mt-8 pl-6 border-l-2 border-nissa-rose">
                    ...
                    <p
                        class="text-xl md:text-2xl italic text-nissa-choco"
                        style="font-family:'Playfair Display', serif;"
                    >
...
<section class="bg-[#FBF8F3] py-20 md:py-28">
    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            {{-- Beauté --}}
            <div class="group bg-white rounded-3xl p-7 border border-[#eee8e3]
                        hover:shadow-lg transition duration-300">

                <div class="w-12 h-12 rounded-2xl bg-nissa-rose/10
                            flex items-center justify-center mb-6">

                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-6 h-6 text-nissa-rose"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
                ...
                <h3
                    class="text-xl text-nissa-choco font-semibold"
                    style="font-family:'Playfair Display', serif;"
                >
                    Beauté
                </h3>
            ...
            <div class="group bg-white rounded-3xl p-7 border border-[#eee8e3]
                ...
                <div class="w-12 h-12 rounded-2xl bg-nissa-gold/10
                            flex items-center justify-center mb-6">

                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-6 h-6 text-nissa-gold"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
            ...
            <div class="group bg-white rounded-3xl p-7 border border-[#eee8e3]
                ...
                <div class="w-12 h-12 rounded-2xl bg-nissa-sauge/10
                            flex items-center justify-center mb-6">

                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-6 h-6 text-nissa-sauge"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    >
...
<section class="bg-white py-20 md:py-28">
    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div class="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2
                class="text-4xl md:text-5xl font-medium text-nissa-choco"
                style="font-family:'Playfair Display', serif;"
            >
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            {{-- Chouchous --}}
            <a
                href="{{ route('boutique', ['categorie' => 'chouchous']) }}"
            ...
            >
                ...
                <div class="relative">
                    ...
                    <h3
                        class="mt-3 text-3xl text-nissa-choco"
                        style="font-family:'Playfair Display', serif;"
                    >
                        Chouchous
                    </h3>
            ...
            {{-- Crochet --}}
            <a
                href="{{ route('boutique', ['categorie' => 'crochet']) }}"
        ...
        <div class="grid lg:grid-cols-[0.8fr_1.2fr] gap-14 lg:gap-24 items-center">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div class="bg-white rounded-2xl p-6 border border-[#eee8e3]">
                    <span class="text-xs uppercase tracking-[0.25em] text-nissa-rose">
                        01
                    </span>

                    <h3
                        class="mt-3 text-2xl text-nissa-choco"
                        style="font-family:'Playfair Display', serif;"
                    >
                        Satin
                    </h3>
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Douceur, fluidité et élégance.
                    </p>
                </div>


                <div class="bg-white rounded-2xl p-6 border border-[#eee8e3]">
                    <span class="text-xs uppercase tracking-[0.25em] text-nissa-gold">
                        02
                    </span>
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Une matière raffinée et délicate.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-[#eee8e3]">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Texture, profondeur et caractère.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 border border-[#eee8e3]">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Une matière chaleureuse et expressive.
                    </p>
                </div>


                <div class="bg-white rounded-2xl p-6 border border-[#eee8e3] sm:col-span-2">

                    <span class="text-xs uppercase tracking-[0.25em] text-nissa-sauge">
                        05
                    </span>
                    ...
                    <p class="mt-2 text-sm text-gray-500 max-w-xl">
                        Des créations faites main qui donnent à chaque pièce
    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="p-6 rounded-2xl bg-[#FBF8F3]">
                ...
                <h3
                    class="mt-4 text-xl text-nissa-choco"
                    style="font-family:'Playfair Display', serif;"
                >
                    Créativité
                </h3>
...
<section class="relative overflow-hidden bg-nissa-choco text-white py-20 md:py-28">
    ...
    <div
        class="absolute -top-40 -right-40 w-[30rem] h-[30rem]
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <span
                            class="text-nissa-choco group-hover:translate-x-1 transition"
                        >
                            →
                        </span>
