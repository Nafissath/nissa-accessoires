                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:40px 32px;">
                            <h1 style="margin:0 0 24px;font-size:28px;font-family:Georgia,serif;color:#3E2F28;">{{ $envoi->sujet }}</h1>
                            <div style="line-height:1.7;color:#4a3f39;font-size:15px;">
                                {!! nl2br(e($envoi->contenu)) !!}
                            </div>
                    ...
                    <tr>
                        <td style="padding:24px 32px;background:#FBF8F3;text-align:center;">
                            <p style="margin:0;font-size:12px;color:#8a7f78;line-height:1.6;">
                                Vous recevez cet email car vous êtes inscrite à la newsletter Nissa Accessoires.<br>
                                <a href="{{ route('newsletter.desinscription', $tokenDesinscription) }}" style="color:#D98B92;">Se désinscrire</a>
                            </p>
                        </td>
                    </tr>
                </table>
