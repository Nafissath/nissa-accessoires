...
@section('content')
    ...
    <section class="relative min-h-[85vh] overflow-hidden flex items-center">
        ...
        <img src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=1600&q=90" alt="Accessoires élégants"
...
<img src="{{ asset('images/accueil3.jpeg') }}" 
     alt="Chouchou satin Nissa sur cheveux naturels"
     class="absolute inset-0 w-full h-full object-cover">
    ...
    <section class="py-24 bg-gradient-to-br from-nissa-cream via-white to-nissa-cream relative overflow-hidden">
        <div class="absolute top-20 left-10 text-[200px] font-bold text-nissa-rose/5 select-none"
            style="font-family: 'Playfair Display', serif;">N</div>

        <div class="relative max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div class="relative">
                <div
                    class="absolute -inset-4 bg-gradient-to-br from-nissa-rose to-nissa-gold rounded-3xl opacity-20 blur-2xl">
                </div>
                <img src="https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=800&q=90"
                    alt="Artisanat fait main" class="relative rounded-3xl shadow-2xl">

                <!-- Badge flottant -->
                <div
                    class="absolute -bottom-8 -right-8 bg-gradient-to-br from-nissa-rose to-nissa-rose-dark text-white p-6 rounded-3xl shadow-2xl hidden md:block animate-bounce-slow">
                ...
                <!-- Petit badge -->
                <div
                    class="absolute -top-4 -left-4 bg-nissa-choco text-white px-4 py-2 rounded-2xl shadow-xl hidden md:block">
                    <p class="text-xs uppercase tracking-widest">Depuis 2025</p>
                </div>
            </div>

            <div>
                <span
                    class="inline-block px-4 py-1 bg-nissa-rose/10 text-nissa-rose text-sm font-semibold uppercase tracking-wider rounded-full mb-4">Notre
                    histoire</span>
                <h2 class="text-4xl md:text-6xl font-bold mb-8 leading-tight"
                    style="font-family: 'Playfair Display', serif;">
                    Nissa, c'est <span class="italic text-gradient"
                        style="background: linear-gradient(135deg, #D98B92 0%, #C9A961 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">vous</span>
                </h2>
                <p class="text-lg text-gray-700 leading-relaxed mb-5">
                    <strong class="text-nissa-choco">Nissa</strong> vient de l'arabe et signifie <em
                        class="text-nissa-rose font-semibold">"femme"</em>.
                ...
                <p class="text-lg text-gray-700 leading-relaxed mb-8">
                    ...
                    Des chouchous qui prennent soin de vos cheveux, aux accessoires au crochet qui révèlent votre style
                    unique.
                </p>
    ...
    <section class="py-24 relative overflow-hidden"
        style="background: linear-gradient(135deg, #3D2817 0%, #6B4423 50%, #3D2817 100%);">
        <!-- Décorations -->
        ...
        <div class="relative max-w-4xl mx-auto px-4 text-center text-white">
            <span
                class="inline-block px-4 py-1 bg-white/10 backdrop-blur text-nissa-rose text-sm font-semibold uppercase tracking-wider rounded-full mb-6 border border-white/20">
                Newsletter
            </span>
            <h2 class="text-4xl md:text-6xl font-bold mb-6 leading-tight" style="font-family: 'Playfair Display', serif;">
                ...
                <span class="italic text-gradient"
                    style="background: linear-gradient(135deg, #E8B4B8 0%, #C9A961 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Nissa</span>
            </h2>
            ...
            <form
                class="max-w-md mx-auto flex flex-col sm:flex-row gap-3 p-2 bg-white/10 backdrop-blur rounded-full border border-white/20">
                <input type="email" placeholder="Votre adresse email"
                    class="flex-1 px-6 py-3 bg-transparent text-white placeholder-white/60 focus:outline-none">
                <button type="submit"
                    class="bg-nissa-rose hover:bg-nissa-rose-dark text-white px-8 py-3 rounded-full font-semibold transition shadow-xl hover:shadow-nissa-rose/50 whitespace-nowrap">
                    S'abonner
                </button>
            </form>
